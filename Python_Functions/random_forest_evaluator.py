...
def random_forest_eval(X,y):
    ...
    This will utilize default RandomForestClassifier() parameters.
...
def rf_model_feature_importance(features, model):
    '''
    Arguments: a Random Forest model model and a list of feature names.
    Returns: a plot with feature importance of the listed features, from the given model.
    '''
