'''
Functions to evaluate an XGBoost classification model.
'''
...
def confusion_matrix_generator(confusion_matrix, name):
    '''
    Arguments: takes in the basic confusion matrix, and the type of model being used (for title purposes).
